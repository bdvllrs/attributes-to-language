...
location_writer = QuantizedWriter(
    quantized_values=np.array(
        [[10, 16, 22, 10, 16, 22, 10, 16, 22], [10, 10, 10, 16, 16, 16, 22, 22, 22]]
    ),
    labels=[
...
color_large_set_writer = QuantizedWriter(
    quantized_values=COLORS_LARGE_SET["rgb"], labels=COLORS_LARGE_SET["labels"]
)

color_sparse_writer = QuantizedWriter(
    quantized_values=COLORS_SPARSE["rgb"], labels=COLORS_SPARSE["labels"]
)
...
writers = {
    ...
    "rotation": [
        ...
        continuous_rotation_writer,
    ],
    "size": [size_writer],
    "color": [color_large_set_writer, color_sparse_writer],
