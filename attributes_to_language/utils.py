...
_color_labels, _color_quantized_values = zip(*_color_large_set_dict.items())
COLORS_LARGE_SET = {
    "labels": list(_color_labels),
    "rgb": np.stack(list(_color_quantized_values), axis=1),
}
...
_color_sparse_labels = ["azure", "beige", "black", "blue", "brown", "crimson", "cyan",
                        "dark blue", "dark cyan", "dark grey", "dark green", "dark orange",
                        "dark red", "dark violet", "grey", "green", "indigo", "light blue",
                        "light grey", "light green", "light pink", "light yellow", "lime",
                        "magenta", "medium blue", "orange", "pale green", "pink", "purple",
                        "red", "turquoise", "violet", "white", "yellow"]

COLORS_SPARSE = {
    "labels": _color_sparse_labels,
    "rgb": np.stack([
        _color_large_set_dict[label] for label in _color_sparse_labels
    ], axis=1)
}

# xkcd colors. Original: https://xkcd.com/color/rgb.txt
...
_xkcd_color_labels, _xkcd_color_quantized_values = zip(*_xkcd_colors.items())
COLORS_XKCD = {
    "labels": list(_xkcd_color_labels),
    "rgb": np.stack(list(_xkcd_color_quantized_values), axis=1),
}
